  ...
  return (
    <div className="flex items-center justify-center mt-24 ">
        <div className="max-w-full  w-full mx-auto">
            <div className="p-14 max-w-full  w-full bg-[--textColor] text-center rounded-xl overflow-hidden">
                ...
                <form className="relative mt-10  mx-auto   bg-nonesparent h-12 rounded-full shadow-md w-full sm:w-full">
                    ...
                    <button role="button" aria-label="Subscribe" className="relative  mt-10 right-0 top-0   w-full  sm:w-96  h-12 text-[--textColor] bg-[--bg]  shadow-md   text-2xl  font-medium  hover:text-[--bg] hover:bg-[--textColor] border-2 border-[--bg ] hover:border-white rounded-full">Subscribe</button>
            </div>
        </div>
    </div>
  )
