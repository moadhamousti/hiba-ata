...
const AuthLinks = () => {
  ...
  return (
    <>
      ...
      <button className=" py-2 px-4 inline-flex items-center text-[--TextColor] font-semibold  rounded-3xl capitalize border-2 border-[--textColor] border-solid border-light hover:scale-105 transition-all ease duration-200 text-sm sm:text-base max-md:text-xs max-md:font-normal   max-sm:hidden">
      GET STARTED
