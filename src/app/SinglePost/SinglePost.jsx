...
//             <h1 className='text-4xl text-[--textColor]'>Details post</h1>
//         <div className=" bg-[--bg] flex ">
//             <div className="w-1/2 p-2">
//                 <img src="imagePost.png" alt="" />
//             </div>
//             <div className="w-1/2">
//             <p>Crafted with precision and innovation, this cutting-edge equipment is designed to elevate your fitness journey to unprecedented heights. Whether you're a seasoned athlete or just embarking on your wellness quest</p>
//             <div className=''>
...
//             <button role="button" aria-label="Subscribe" className="relative  mt-10 right-0 top-0   w-full  sm:w-96  h-12 text-[--bg] bg-[#00A4BF]  shadow-md   text-2xl  font-medium  hover:text-[#00A4BF] hover:bg-[--bg] border-2 border-[--bg ] hover:border-white rounded-full">Subscribe</button>
//             <button role="button" aria-label="Subscribe" className="relative  mt-10 right-0 top-0   w-full  sm:w-96  h-12 text-[--bg] bg-[#00A4BF]  shadow-md   text-2xl  font-medium  hover:text-[#00A4BF] hover:bg-[--bg] border-2 border-[--bg ] hover:border-white rounded-full">Subscribe</button>
